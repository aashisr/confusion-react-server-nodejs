...
dishRouter
            ...
            .then(
                (dish) => {
                    ...
                    if (dish !== null && dish.comments.id(req.params.commentId) !== null) {
                        ...
                        err = new Error('Comment ' + req.params.commentId + ' not found on dish ' + req.params.dishId);
                        err.status = 404;
                        return next(err);
                    }
                },
    ...
    .post(cors.corsWithOptions, authenticate.verifyUser, (req, res, next) => {
        ...
        //Update the status code to 403
        res.statusCode = 403;
        res.end('POST operation forbidden on /dishes/' + req.params.dishId + '/comments/' + req.params.commentId);
    })
